...
页面顶部可以选择处理类型：微信公众号文章、Notion 文档或 JavBus 页面。Notion 模式会从“作者”和“发布时间”属性命名，并只保留页面正文内容区，避免把属性面板、Relations 等编辑控件混进正文。JavBus 模式会提取影片资料和内嵌主图，按可识别演员数量在文件名前加上“单人”“双人”“多人”或“未识别”，日期使用“YYYY年M月D日”格式，并将“类别”和“演员”各自整理为同一行。
